 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var q,B;class S extends g{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var t,e;const i=super.createRenderRoot();return(t=(e=this.renderOptions).renderBefore)!==null&&t!==void 0||(e.renderBefore=i.firstChild),i}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Pt(e,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),(t=this._$Do)===null||t===void 0||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this._$Do)===null||t===void 0||t.setConnected(!1)}render(){return y}}S.finalized=!0,S._$litElement$=!0,(q=globalThis.litElementHydrateSupport)===null||q===void 0||q.call(globalThis,{LitElement:S});const nt=globalThis.litElementPolyfillSupport;nt==null||nt({LitElement:S});((B=globalThis.litElementVersions)!==null&&B!==void 0?B:globalThis.litElementVersions=[]).push("3.3.2");class Ut extends S{constructor(){super();R(this,"clientMqtt");R(this,"values");console.log("my-app:construct"),console.log(1),this.docsHint="Click on the Vite and Lit logos to learn more",this.count=0,this.connMqtt()}static get properties(){return{hasConnection:{type:Boolean}}}async connMqtt(){const e="mqttjs_"+Math.random().toString(16).substr(2,8);this.clientMqtt=pt().with_websock("wss://thedg.servebeer.com:9090").with_autoreconnect(),await this.clientMqtt.connect({client_id:e,username:"cam1",password:"cam1"}),this.clientMqtt.subscribe_topic("/hello",(i,s,n)=>{console.log("topic packet",s,i,i.json()),hasConnection=!0,this.requestUpdate()})}_onClick2(){this.clientMqtt.send("main/gate/","Hello from mqtt_client"),alert("Portão accionado")}async firstUpdated(){await this.fetchData()}async fetchData(){let e;e=await fetch("./json_profiles/quinta_azevinho.json").then(i=>i.json()),e!=null&&(this.values=e,this.requestUpdate(),console.log("did"))}static get styles(){return vt`
      :host {
        max-width: 1280px;
        margin: 0 auto;
        padding: 2rem;
