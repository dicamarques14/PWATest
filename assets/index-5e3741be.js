 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var j;const M=window,A=M.trustedTypes,Q=A?A.createPolicy("lit-html",{createHTML:o=>o}):void 0,V="$lit$",v=`lit$${(Math.random()+"").slice(9)}$`,ht="?"+v,mt=`<${ht}>`,m=document,w=()=>m.createComment(""),C=o=>o===null||typeof o!="object"&&typeof o!="function",at=Array.isArray,gt=o=>at(o)||typeof(o==null?void 0:o[Symbol.iterator])=="function",q=`[ 	
\f\r]`,E=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,X=/-->/g,Y=/>/g,f=RegExp(`>|${q}(?:([^\\s"'>=/]+)(${q}*=${q}*(?:[^ 	
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var z,I;class S extends g{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var t,e;const i=super.createRenderRoot();return(t=(e=this.renderOptions).renderBefore)!==null&&t!==void 0||(e.renderBefore=i.firstChild),i}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Pt(e,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),(t=this._$Do)===null||t===void 0||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this._$Do)===null||t===void 0||t.setConnected(!1)}render(){return y}}S.finalized=!0,S._$litElement$=!0,(z=globalThis.litElementHydrateSupport)===null||z===void 0||z.call(globalThis,{LitElement:S});const nt=globalThis.litElementPolyfillSupport;nt==null||nt({LitElement:S});((I=globalThis.litElementVersions)!==null&&I!==void 0?I:globalThis.litElementVersions=[]).push("3.3.2");class Ut extends S{constructor(){super();k(this,"clientMqtt");k(this,"values");console.log("my-elem:construct"),this.docsHint="Click on the Vite and Lit logos to learn more",this.count=0,this.connMqtt()}static get properties(){return{docsHint:{type:String},count:{type:Number}}}async connMqtt(){const e="mqttjs_"+Math.random().toString(16).substr(2,8);this.clientMqtt=pt().with_websock("wss://thedg.servebeer.com:9090").with_autoreconnect(),await this.clientMqtt.connect({client_id:e,username:"cam1",password:"cam1"}),console.log("aquisss"),await this.clientMqtt.send("main/gate/","asdasd")}render(){return console.log("render",this.values),this.values!=null?(console.log(this.values),it`
        <div>
        ${this.values.appPerfil.nome}
        </div>
        <div>
        <img src="${this.values.appPerfil.imagem}"></img>
        </div>
        <div class="card">
